...
const rangeOptions = [
  ...
  { from: 'now-6h', to: 'now', display: 'Last 6 hours', section: 0 },
  { from: 'now-12h', to: 'now', display: 'Last 12 hours', section: 0 },
  { from: 'now-24h', to: 'now', display: 'Last 24 hours', section: 0 },
