...
require (
	...
	github.com/beevik/etree v1.5.0 // @grafana/grafana-backend-group
	...
	github.com/grafana/grafana-app-sdk v0.48.4 // @grafana/grafana-app-platform-squad
	github.com/grafana/grafana-app-sdk/logging v0.48.3 // @grafana/grafana-app-platform-squad
	...
	github.com/prometheus/common v0.67.3 // @grafana/alerting-backend
	...
	github.com/russellhaering/goxmldsig v1.5.0 // @grafana/grafana-backend-group
	...
	github.com/urfave/cli/v3 v3.5.0 // @grafana/grafana-backend-group
